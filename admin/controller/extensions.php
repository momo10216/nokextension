...
class NoKExtensionControllerExtensions extends JControllerAdmin {
	public function getModel($name = 'Extension', $prefix = 'NoKExtensionModel', $config = array('ignore_request' => true)) {
